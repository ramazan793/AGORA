...
from ..eg3d.metrics.metric_main_mesh import register_metric


from ..dataset.image_folder_dataset import DGGHeadMaskImageFolderDataset, GGHeadImageFolderDatasetConfig


@register_metric
def fid100(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    opts.dataset = DGGHeadMaskImageFolderDataset(GGHeadImageFolderDatasetConfig(**opts.dataset_kwargs))
