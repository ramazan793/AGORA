...
from src.gghead.model_manager.base_model_manager import GGHeadTrainSetup, GGHeadGANOptimizerConfig, GGHeadGANConfig, \
    BaseModelManager, \
    BaseModelFolder
...
class GGHeadModelManager(BaseModelManager):
    ...
    def __init__(self, run_name: str):
        super().__init__('dgghead', run_name)
...
class DGGHeadModelFolder(BaseModelFolder[GGHeadModelManager]):
    def __init__(self):
        super().__init__('dgghead', 'DGGHEAD')
